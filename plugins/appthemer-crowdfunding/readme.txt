...
Plugin URI: http://FundifyTheme.com
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=info@virtuousgiant.com&item_name=Donation+for+Crowdfunding
...
A WordPress crowdfunding plugin that integrates with Easy Digital Downloads and the Fundify theme.

== Description ==

[Fundify Crowdfunding](http://fundifytheme.com/?utm_source=WPdotOrg&utm_medium=link&utm_campaign=Fundify) is a crowdfunding platform for WordPress that integrates with Easy Digital Downloads and the Fundify theme. An extension that seamlessly integrates with [Easy Digital Downloads](http://wordpress.org/extend/plugins/easy-digital-downloads/), the Fundify Crowdfunding plugin lets you crowd fund everything from films, games, music to art, design and technology or anything you can think of.
...
Note: The Fundify Crowdfunding plugin is designed to work alongside the WePay, PayPal Adaptive Payments or Stripe gateway so that pledges are collected but no funds are taken until the campaign reaches its goal. The plugin will also work along side any other gateway that Easy Digital Downloads supports but funds will be taken immediately.

= Features =

Features of the plugin include:

* Crowdfund anything you want!
...
* Easy to theme and integrate into your own site already using Easy Digital Downloads.

= Premium Themes =

We currently have two compatible themes, both developed, maintained, and supported by [IgnitionDeck](http://ignitiondeck.com/id/?utm_source=WPdotOrg&utm_medium=link&utm_campaign=Fundify)

* [Fundify](http://fundifytheme.com/?utm_source=WPdotOrg&utm_medium=link&utm_campaign=Fundify): Fundify is the first WordPress theme that lets you create your own crowdfunding website. If you have wanted a site like KickStarter or Indiegogo for your own projects, now you can have one using Fundify, the crowdfunding theme for WordPress.
* [CrowdPress](http://fundifytheme.com/?utm_source=WPdotOrg&utm_medium=link&utm_campaign=Fundify): Set up your own crowd-funding website with CrowdPress for WordPress.

== Installation ==

1. Install the Easy Digital Downloads plugin and activate it, if you haven't already.
2. Install the Fundify Crowdfunding plugin and activate it.
...
https://github.com/VirtuousGiant/crowdfunding/issues?milestone=17&page=1&state=closed
...
https://github.com/VirtuousGiant/crowdfunding/issues?milestone=16&page=1&state=closed
...
https://github.com/VirtuousGiant/crowdfunding/issues?milestone=14&page=1&state=closed

* New: MAJOR: [File changes/organization](https://github.com/VirtuousGiant/crowdfunding/issues/246)
* New: MAJOR: Custom pledge amounts have been removed from the theme, and added to the plugin. [More](https://github.com/VirtuousGiant/crowdfunding/issues/244)
...
https://github.com/VirtuousGiant/crowdfunding/issues?milestone=11&page=1&state=closed
...
https://github.com/VirtuousGiant/crowdfunding/issues?milestone=12&page=1&state=closed

* Fix: Bug with account creation / secure password error fixed.

https://github.com/VirtuousGiant/crowdfunding/issues?milestone=9&page=1&state=closed
...
https://github.com/VirtuousGiant/crowdfunding/issues?milestone=10&state=closed
...
https://github.com/VirtuousGiant/crowdfunding/issues?milestone=8&page=1&state=closed
...
https://github.com/VirtuousGiant/crowdfunding/issues?milestone=7&page=1&state=closed
...
https://github.com/VirtuousGiant/crowdfunding/issues?milestone=6&state=closed
...
https://github.com/VirtuousGiant/crowdfunding/issues?milestone=5&state=closed
...
https://github.com/VirtuousGiant/crowdfunding/issues?milestone=4&state=closed

<?php
if (!class_exists('VotesAdvancedExcerpt')):

    class VotesAdvancedExcerpt {
        ...
        public static function Instance($new = false) {
            if (self::$inst == null || $new) {
                self::$inst = new VotesAdvancedExcerpt();
            }
            return self::$inst;
        }
        ...
        private function __construct() {
            ...
            // Replace everything
            global $post;
            if(isset($post) && $post->post_type == VOTES_TYPE){
        ...
        private function update_options() {
            ...
            $this->load_options();
            ?>
            <div id="message" class="updated fade"><p><?php _e('Options saved.','voting-contest'); ?></p></div>
            <?php
        }
        ...
        public function page_options() {
            ...
            ?>
            <div class="wrap">
                <h2><?php _e("Contest Excerpt Options",'voting-contest');?></h2>
                ...
                <table class="form-table">
                        <tr valign="top">
                            <th scope="row">
                                    <label for="<?php echo $this->name; ?>_length"><?php _e("Excerpt Length:",'voting-contest'); ?></label>
                            </th>
                            <td>
                                ...
                                <input name="<?php echo $this->name; ?>_use_words" type="checkbox"
                                       id="<?php echo $this->name; ?>_use_words" value="on"<?php echo (1 == $use_words) ? ' checked="checked"' : ''; ?>/>
                                <?php _e("Use words?",'voting-contest'); ?>
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo $this->name; ?>_ellipsis"><?php _e("Ellipsis:",'voting-contest'); ?></label></th>
                            <td>
                    ...
                    <?php _e("Will substitute the part of the post that is omitted in the excerpt.",'voting-contest'); ?>
                        ...
                        <tr valign="top">
                            <th scope="row"><label for="<?php echo $this->name; ?>_length">
                                    <?php _e("Finish:",'voting-contest'); ?></label></th>
                            <td>
                                <input name="<?php echo $this->name; ?>_finish_word" type="checkbox"
                                       id="<?php echo $this->name; ?>_finish_word" value="on"<?php echo (1 == $finish_word) ? ' checked="checked"' : ''; ?>/>
            <?php _e("Word",'voting-contest'); ?><br/>
                                <input name="<?php echo $this->name; ?>_finish_sentence" type="checkbox"
                                       id="<?php echo $this->name; ?>_finish_sentence" value="on"<?php echo (1 == $finish_sentence) ? ' checked="checked"' : ''; ?>/>
            ...
            <?php _e("&lsquo;Read-more&rsquo; Text:",'voting-contest'); ?></label></th>
                            <td>
                                ...
                                <input name="<?php echo $this->name; ?>_add_link" type="checkbox"
                                       id="<?php echo $this->name; ?>_add_link" value="on" <?php echo (1 == $add_link) ? 'checked="checked" ' : ''; ?>/>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input name="<?php echo $this->name; ?>_no_custom" type="checkbox"
                                       id="<?php echo $this->name; ?>_no_custom" value="on" <?php echo (1 == $no_custom) ? 'checked="checked" ' : ''; ?>/>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input name="<?php echo $this->name; ?>_no_shortcode" type="checkbox"
                                       id="<?php echo $this->name; ?>_no_shortcode" value="on" <?php echo (1 == $no_shortcode) ? 'checked="checked" ' : ''; ?>/>
            ...
            <?php _e("Don't remove any markup",'voting-contest'); ?>
                                ...
                                <a href="" id="<?php echo $this->name; ?>_select_all"><?php _e('Select all','voting-contest'); ?></a>
                                / <a href="" id="<?php echo $this->name; ?>_select_none"><?php _e('Select none','voting-contest'); ?></a><br />
                                ...
                                <input type="button" name="<?php echo $this->name; ?>_add_tag" id="<?php echo $this->name; ?>_add_tag" class="button" value="<?php _e('Add tag','voting-contest'); ?>" />
                            </td>
                        </tr>
                    </table>
                    <p class="submit"><input type="submit" name="Submit" class="button-primary"
                                    ...
                                    public function page_script() {
                                     wp_enqueue_script($this->name . '_script', VOTES_PATH . 'scripts/votes-advanced-excerpt.js');
                                    }

                                    public function add_pages() {
                                        $options_page = add_submenu_page(VOTES_TYPE, __("Advanced Excerpt Options",'voting-contest'), __("Excerpt",'voting-contest'), 'manage_options', 'options-' . $this->name, array(
                                            &$this,
                                            'page_options'
                                        ));
...
VotesAdvancedExcerpt::Instance();

// Do not use outside the Loop!
function votes_advanced_excerpt($args = '', $get = false) {
    ...
    VotesAdvancedExcerpt::Instance()->options = $args;

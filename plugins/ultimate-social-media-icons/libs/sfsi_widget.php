        ...
        case "twitter" :
			 ...
			 ///print_r($sfsi_section2_options);
                     if($sfsi_section2_options['sfsi_twitter_followme']=="yes" || $sfsi_section2_options['sfsi_twitter_aboutPage']=="yes" || $sfsi_section2_options['sfsi_twitter_page']=="yes")
                     {
                         ...
                         {
                             $hoverdiv.="<div  class='icon2'>".$socialObj->sfsi_twitterFollow($twitter_user)."</div>";
                         }    
                         if($sfsi_section2_options['sfsi_twitter_aboutPage']=="yes")
                         {
                             $hoverdiv.="<div  class='icon3'>".$socialObj->sfsi_twitterShare($current_url,$twitter_text)."</div>";
                         } 
